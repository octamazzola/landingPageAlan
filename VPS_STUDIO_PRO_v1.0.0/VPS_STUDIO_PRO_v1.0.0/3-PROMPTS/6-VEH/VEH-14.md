# VEH-14 · Motorcycle passing through a visible traffic lane
...
ANALYSIS + GATE  Before editing, identify the drivable and support planes, curb and lane geometry, parking or stopping logic, horizon, vanishing points, camera height, focal perspective, depth of field, scale cues, light direction, shadow softness, exposure, white balance, reflections, atmosphere, sharpness, noise and grain. Apply the scenario gate exactly. If the visible space cannot support the vehicle legally, physically and credibly, do not force the insertion; return the architecture unchanged. Use only with a clearly visible legal lane, safe path and scale reference. The source must support a rider silhouette without hiding essential architectural information.

REQUESTED EDIT  Add one ordinary unbranded street motorcycle with a single adult rider traveling naturally inside the existing lane. Use an upright, calm urban riding posture, neutral helmet and restrained clothing; keep anatomy and hands physically correct. Align both wheels, body lean and travel direction to the lane geometry. Apply subtle rotational blur to the wheels and mild directional softness to the motorcycle-rider silhouette only, while preserving the road and architecture sharp. Keep the figure small and secondary.
...
LANE CONTACT LOCK  Both tires must contact only the existing asphalt traffic lane, with the motorcycle body and rider contained inside the same lane envelope. No tire or body may overlap a curb, sidewalk, cycle lane, plaza, accessible ramp, landscape area, crosswalk or forecourt. Do not invent a lane, shoulder, curb cut or marking. If a safe, unobstructed motorcycle path cannot be read from the visible roadway, do not insert it.
