# VEH-08 · Motorcycle in a designated parking bay
...
ANALYSIS + GATE  Before editing, identify the drivable and support planes, curb and lane geometry, parking or stopping logic, horizon, vanishing points, camera height, focal perspective, depth of field, scale cues, light direction, shadow softness, exposure, white balance, reflections, atmosphere, sharpness, noise and grain. Apply the scenario gate exactly. If the visible space cannot support the vehicle legally, physically and credibly, do not force the insertion; return the architecture unchanged. Use only where the support plane is dry, stable and separated from primary pedestrian circulation; a credible lean clearance must exist.

REQUESTED EDIT  Add one ordinary contemporary street motorcycle parked on its side stand within the existing designated or legal parking area. Turn the front wheel slightly toward the stand side, apply a modest physically correct lean and align both tire contact points to the same ground plane. Use dark neutral bodywork without brand marks, rider, helmet or accessories. Keep clear of walls, glass, doors and pedestrian movement.
...
PARKING CONTACT LOCK  Both tires and the side-stand foot must contact the same existing designated parking surface. No contact point or motorcycle body may touch or overlap a curb, sidewalk, plaza, accessible ramp, landscape area, building threshold or circulation path. Do not invent a motorcycle bay, stand plate, curb cut or marking. If the visible bay cannot contain the motorcycle's full footprint, lean angle and safety clearance, do not insert it.
