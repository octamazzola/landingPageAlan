# VEH-04 · Delivery van in an existing loading zone
...
ANALYSIS + GATE  Before editing, identify the drivable and support planes, curb and lane geometry, parking or stopping logic, horizon, vanishing points, camera height, focal perspective, depth of field, scale cues, light direction, shadow softness, exposure, white balance, reflections, atmosphere, sharpness, noise and grain. Apply the scenario gate exactly. If the visible space cannot support the vehicle legally, physically and credibly, do not force the insertion; return the architecture unchanged. A service route, adequate turning space and a stopping area separated from principal pedestrian circulation must be clearly supported.

REQUESTED EDIT  Add one medium unbranded delivery van stopped within the existing loading or service area. Keep all doors closed unless an existing platform and unobstructed service relationship make one open rear door physically credible. Use plain white, graphite or muted paint with no company graphics. Preserve loading clearances, fire access, door swings and all pedestrian routes; the vehicle must explain service function without becoming a commercial focal point.
...
SERVICE ZONE CONTACT LOCK  Every tire and the full van footprint must remain on the existing loading or service pavement. No wheel may touch a dock edge, curb, sidewalk, ramp, plaza, landscape strip or pedestrian route. Do not invent a loading bay, service apron, curb cut, dock or marking. Preserve the visible separation between service and pedestrian surfaces. If the zone cannot contain the van plus door, turning and safety clearances, do not insert it.
