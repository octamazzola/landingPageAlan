# VEH-11 · Car entering an existing driveway at low speed
...
ANALYSIS + GATE  Before editing, identify the drivable and support planes, curb and lane geometry, parking or stopping logic, horizon, vanishing points, camera height, focal perspective, depth of field, scale cues, light direction, shadow softness, exposure, white balance, reflections, atmosphere, sharpness, noise and grain. Apply the scenario gate exactly. If the visible space cannot support the vehicle legally, physically and credibly, do not force the insertion; return the architecture unchanged. Use only when the source shows an unobstructed approach, a real curb cut or driveway and enough visible geometry to resolve the turning path without guessing hidden space.

REQUESTED EDIT  Add one unbranded compact passenger car beginning a slow turn from the existing carriageway into the visible driveway. Set a modest, physically correct front-wheel steering angle and keep the rear wheels following a credible swept path. Express low-speed movement through slight wheel rotation and a minimal directional softness confined to the vehicle; preserve the architecture, ground, curb and all static context sharp. Keep the car clear of pedestrians, gates, columns, planting and the opposite lane.
...
TURNING PATH LOCK  The front and rear tire paths must remain entirely within the existing roadway, the visible curb cut and the defined driveway crossing. No wheel may climb an intact curb or leave the curb-cut width onto ordinary sidewalk, accessible ramp, tactile paving, planting or forecourt surfaces. Do not widen, lower or interrupt the curb and do not invent a driveway connection. If the complete swept path from lane to driveway cannot be resolved from visible geometry, do not insert the turning car.
